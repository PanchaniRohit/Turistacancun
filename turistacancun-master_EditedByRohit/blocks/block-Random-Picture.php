...
<?php
/*****************************************************************************
* Depliega el Bloque central para Cancun.info
* Autor: Enrique Montes (emontes@turista.com.mx
 *****************************************************************************/
...
foreach ($result as $row){
    ...
    if ($contador < $numberpic){ 
      ...
      $tirafotos .= '<td align="center" valign="baseline"><a href="modules.php?name=Photos&pid='.$row['pid'].'" target="blank"><img src="'.$picurl.'" border="0" alt="' . $thumb_title . '" title="' . $thumb_title . '"><br />' . $thumb_title . '</a></td>';
      $contador ++;
    } else {//if contador 
