...
/************************************************************/
/* Opciones de Lenguaje específicas de Cancun.info*/



// Nombres de Bloques
define("_TRAVELLERS","Cancun Travellers");

//Opciones de los Bloques
define("_THOTELS","Cancun Hotels");
define("_TRESTAURANTS","Restaurants");
define("_TEXCURSIONS","Excursions");
define("_TMAPS","Maps");
define("_TENTERTAINMENT","Entertainment");
define("_TFORUM","<a href=\"modules.php?op=modload&name=Forums&file=viewforum&forum=1\">Forum");
define("_TBROCHURES","Brochures");
